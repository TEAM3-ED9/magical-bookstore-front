 ...
 */
/**
 * TextGenerateEffectOriginal Component
 *
 * This component animates a given string of words by applying a blur effect and fading them in sequentially.
 * It uses Framer Motion for animations and supports customization of animation duration, blur effect, and additional CSS classes.
 *
 * @component
 * @param {Object} props - The props object.
 * @param {string} props.words - The string of words to be animated. Words are split by spaces.
 * @param {string} [props.className] - Additional CSS classes to style the component.
 * @param {boolean} [props.filter=true] - Whether to apply a blur effect to the words before animation.
 * @param {number} [props.duration=0.5] - The duration of the animation for each word in seconds.
 * @returns {React.ReactElement} The animated text component.
 */
export const TextGenerateEffectOriginal = ({ words, className, filter = true, duration = 0.5 }) => {
  /**
